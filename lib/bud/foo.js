 ...
 * @param {boolean} [config.done] - Done to writeout or not.
 * @param {boolean} [config.mkdirp] - Make parent directories if needed.
 * @param {undefined} [config.setup] - Properties to set engine.
 ...
 * @param {string} [config.src] - Bud source file path.
...
Bud.prototype = {
    ...
    validate: function () {
        ...
        _assertType(s.setup, ['undefined'], 'bud.setup should be .');
