...
/** @lends module:coz/lib/template/engines.HandlebarsEngine */
...
HandlebarsEngine.buildinHelpers = {
     ...
     */
    read: function (value) {
        var basedir = HandlebarsEngine._basedirWithContext(arguments[1]);
...
HandlebarsEngine._basedirWithContext = function (ctx) {
