...
var precompiled = Handlebars.template({"1":function(depth0,helpers,partials,data) {
	  ...
	  return "{@link module:"
	    + alias1(this.lambda(((stack1 = (depths[3] != null ? depths[3].doc : depths[3])) != null ? stack1.module : stack1), depth0))
	    ...
	    + alias1((helpers.camelcase || (depth0 && depth0.camelcase) || alias2).call(depth0,(depth0 != null ? depth0.name : depth0),{"name":"camelcase","hash":{},"data":data}))
	    + "|"
	    + alias1((helpers.camelcase || (depth0 && depth0.camelcase) || alias2).call(depth0,(depth0 != null ? depth0.name : depth0),{"name":"camelcase","hash":{},"data":data}))
	    + " module}.";
