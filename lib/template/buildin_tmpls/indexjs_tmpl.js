...
var precompiled = Handlebars.template({"1":function(depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.doc : depth0),{"name":"if","hash":{},"fn":this.program(4, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
	    + "    get "
	    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.isPascal : depth0),{"name":"if","hash":{},"fn":this.program(7, data, 0),"inverse":this.program(9, data, 0),"data":data})) != null ? stack1 : "")
	    + "() { return require('./"
	    ...
	    + "'); }"
	    + ((stack1 = helpers['if'].call(depth0,(data && data.last),{"name":"if","hash":{},"fn":this.program(11, data, 0),"inverse":this.program(13, data, 0),"data":data})) != null ? stack1 : "");
	},"4":function(depth0,helpers,partials,data) {
	    var stack1;
	
	  return "    /**\n"
	    + ((stack1 = helpers.each.call(depth0,(depth0 != null ? depth0.doc : depth0),{"name":"each","hash":{},"fn":this.program(5, data, 0),"inverse":this.noop,"data":data})) != null ? stack1 : "")
	    + "     */\n";
