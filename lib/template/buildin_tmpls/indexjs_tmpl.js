...
var precompiled = Handlebars.template({"1":function(depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.isSubmodules : depth0),{"name":"if","hash":{},"fn":this.program(4, data, 0, blockParams, depths),"inverse":this.noop,"data":data})) != null ? stack1 : "")
	    + "    "
	    + ((stack1 = helpers['if'].call(depth0,(depth0 != null ? depth0.isSubclass : depth0),{"name":"if","hash":{},"fn":this.program(6, data, 0, blockParams, depths),"inverse":this.program(8, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "")
	    + "() { return require('./"
	    ...
	    + "'); }"
	    + ((stack1 = helpers['if'].call(depth0,(data && data.last),{"name":"if","hash":{},"fn":this.program(10, data, 0, blockParams, depths),"inverse":this.program(12, data, 0, blockParams, depths),"data":data})) != null ? stack1 : "");
	  ...
	  return "    /**\n      * @see {@link module:"
	    ...
	    + "/"
	    + alias2((helpers.camelcase || (depth0 && depth0.camelcase) || helpers.helperMissing).call(depth0,(depth0 != null ? depth0.name : depth0),{"name":"camelcase","hash":{},"data":data}))
